...
CREATE TABLE `device` (
  ...
  `category` 			enum('UNKNOWN','WATER_HEATING','HEATING','COOKING','SHOWERS','WASHING_DRYING','LIGHTING','AUDIOVISUAL','COLD_APPLIANCES','ICT','OTHER','ELECTRICAL_PANEL','WIND_ENG','SOLOR_ENG','EXTERNAL_ENG','BIOMASS_ENG','HYDRO_ENG', 'BATTERY_ENG', 'HYBRID') DEFAULT 'UNKNOWN',
...
CREATE TABLE `device_statistic`(
	`device_category`	ENUM('UNKNOWN','WATER_HEATING', 'HEATING', 'COOKING', 'SHOWERS', 'WASHING_DRYING', 'LIGHTING'
						...
						, 'WIND_ENG', 'SOLOR_ENG', 'EXTERNAL_ENG', 'BIOMASS_ENG', 'HYDRO_ENG', 'BATTERY_ENG', 'HYBRID')
			 			DEFAULT 'UNKNOWN',
