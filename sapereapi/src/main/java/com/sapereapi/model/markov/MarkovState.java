...
public class MarkovState implements Cloneable, Serializable {
	...
	public MarkovState(Integer id, BooleanOperator minCondition, Double minValue, BooleanOperator maxCondition,
			Double maxValue) {
		super();
		this.id = id;
