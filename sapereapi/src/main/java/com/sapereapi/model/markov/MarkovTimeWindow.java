...
public class MarkovTimeWindow implements Serializable {
	...
	public MarkovTimeWindow() {
		super();
	}

	public MarkovTimeWindow(int id, Set<Integer> daysOfWeek, int startHour, int startMinute, int endHour,
			int endMinute) {
		super();
		this.id = id;
