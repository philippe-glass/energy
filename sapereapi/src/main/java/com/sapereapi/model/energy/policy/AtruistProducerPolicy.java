...
public class AtruistProducerPolicy extends BasicProducerPolicy {
	protected double creditThreasholdHW = -1.5;

	public AtruistProducerPolicy(NodeContext nodeContext, Double rate, int _requestSelectionPolicy, boolean useAwardCredits, double creditThreasholdHW) {
		super(nodeContext, rate, _requestSelectionPolicy, useAwardCredits);
