...
public class PredictionStatistic implements Serializable {
	...
	private LearningAggregationOperator aggregationOperator = null;
	...
	private Double crossEntropyLoss = null;
	...
	public void setCrossEntropyLoss(Double crossEntropyLoss) {
	...
	public String getKeyOfStateDistribution() {
		...
		return StatesStatistic.generateKey(scope, stateDate, UtilDates.getHourOfDay(stateDate), variable);
	...
	public boolean isTrivial() {
		return statesStatistic != null && statesStatistic.isTrivial();
	}
}
